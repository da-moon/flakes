...
{ }:
{
  ...
  defaultSettings = {
    ...
    tui = {
      ...
      hyperlinks = "auto";
      tight = false;
      # 18.0.4: upstream removed the boolean "tui.scrollbackRebuild" in
      # favor of the pre-existing "tui.resizeScrollback" enum, whose default
      # also changed ("append" -> "rebuild").
    ...
    # 18.0.4 added update.channel (enum: stable/canary; default "stable").
    update = {
      channel = "stable";
    };
    magicKeywords = {
    ...
    edit = {
      ...
      # 18.2.6 changed the upstream default from false to true.
      enforceSeenLines = true;
      # 18.0.4 added edit.autoRepair.enabled and edit.blackbox.enabled
      # (both default false).
      autoRepair = {
        enabled = false;
      };
    ...
    bash = {
      ...
      patterns = [ ];
      autoBackground = {
        # Upstream default changed from false to true in 18.0.4.
        enabled = true;
        thresholdMs = 60000;
      };
    };
    ...
    features = {
      # 18.0.4: upstream changed unexpectedStopDetection from boolean to an
      # enum (none/mechanical/smart); default changed false -> "mechanical".
